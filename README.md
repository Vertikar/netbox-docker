[![Build Status](https://travis-ci.org/Vertikar/netbox-docker.svg?branch=master)](https://travis-ci.org/Vertikar/netbox-docker)
...
```
# git clone -b master https://github.com/vertikar/netbox-docker.git
# cd netbox
# docker-compose up -d
```
